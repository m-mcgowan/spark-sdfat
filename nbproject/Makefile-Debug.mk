...
${OBJECTDIR}/MinimumSerial.o: MinimumSerial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MinimumSerial.o MinimumSerial.cpp

${OBJECTDIR}/Sd2Card.o: Sd2Card.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sd2Card.o Sd2Card.cpp

${OBJECTDIR}/SdBaseFile.o: SdBaseFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdBaseFile.o SdBaseFile.cpp

${OBJECTDIR}/SdBaseFilePrint.o: SdBaseFilePrint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdBaseFilePrint.o SdBaseFilePrint.cpp

${OBJECTDIR}/SdFat.o: SdFat.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFat.o SdFat.cpp

${OBJECTDIR}/SdFatErrorPrint.o: SdFatErrorPrint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFatErrorPrint.o SdFatErrorPrint.cpp

${OBJECTDIR}/SdFatUtil.o: SdFatUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFatUtil.o SdFatUtil.cpp

${OBJECTDIR}/SdFile.o: SdFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFile.o SdFile.cpp

${OBJECTDIR}/SdStream.o: SdStream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdStream.o SdStream.cpp

${OBJECTDIR}/SdVolume.o: SdVolume.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdVolume.o SdVolume.cpp

${OBJECTDIR}/StorageDevice.o: StorageDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StorageDevice.o StorageDevice.cpp

${OBJECTDIR}/istream.o: istream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/istream.o istream.cpp

${OBJECTDIR}/ostream.o: ostream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ostream.o ostream.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/test/SdFatTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} ../core-firmware/brewpi/brewpi-avr/googletest/dist/Debug/MinGW-Windows/libgoogletest.a 


${TESTDIR}/test/SdFatTest.o: test/SdFatTest.cpp 
	${MKDIR} -p ${TESTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -DARDUINO=105 -I. -I. -Itest -MMD -MP -MF "$@.d" -o ${TESTDIR}/test/SdFatTest.o test/SdFatTest.cpp
...
${OBJECTDIR}/MinimumSerial_nomain.o: ${OBJECTDIR}/MinimumSerial.o MinimumSerial.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MinimumSerial_nomain.o MinimumSerial.cpp;\
	else  \
...
${OBJECTDIR}/Sd2Card_nomain.o: ${OBJECTDIR}/Sd2Card.o Sd2Card.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sd2Card_nomain.o Sd2Card.cpp;\
	else  \
...
${OBJECTDIR}/SdBaseFile_nomain.o: ${OBJECTDIR}/SdBaseFile.o SdBaseFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdBaseFile_nomain.o SdBaseFile.cpp;\
	else  \
...
${OBJECTDIR}/SdBaseFilePrint_nomain.o: ${OBJECTDIR}/SdBaseFilePrint.o SdBaseFilePrint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdBaseFilePrint_nomain.o SdBaseFilePrint.cpp;\
	else  \
...
${OBJECTDIR}/SdFat_nomain.o: ${OBJECTDIR}/SdFat.o SdFat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFat_nomain.o SdFat.cpp;\
	else  \
...
${OBJECTDIR}/SdFatErrorPrint_nomain.o: ${OBJECTDIR}/SdFatErrorPrint.o SdFatErrorPrint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFatErrorPrint_nomain.o SdFatErrorPrint.cpp;\
	else  \
...
${OBJECTDIR}/SdFatUtil_nomain.o: ${OBJECTDIR}/SdFatUtil.o SdFatUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFatUtil_nomain.o SdFatUtil.cpp;\
	else  \
...
${OBJECTDIR}/SdFile_nomain.o: ${OBJECTDIR}/SdFile.o SdFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdFile_nomain.o SdFile.cpp;\
	else  \
...
${OBJECTDIR}/SdStream_nomain.o: ${OBJECTDIR}/SdStream.o SdStream.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdStream_nomain.o SdStream.cpp;\
	else  \
...
${OBJECTDIR}/SdVolume_nomain.o: ${OBJECTDIR}/SdVolume.o SdVolume.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SdVolume_nomain.o SdVolume.cpp;\
	else  \
...
${OBJECTDIR}/StorageDevice_nomain.o: ${OBJECTDIR}/StorageDevice.o StorageDevice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StorageDevice_nomain.o StorageDevice.cpp;\
	else  \
...
${OBJECTDIR}/istream_nomain.o: ${OBJECTDIR}/istream.o istream.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/istream_nomain.o istream.cpp;\
	else  \
...
${OBJECTDIR}/ostream_nomain.o: ${OBJECTDIR}/ostream.o ostream.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DARDUINO=105 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ostream_nomain.o ostream.cpp;\
	else  \
